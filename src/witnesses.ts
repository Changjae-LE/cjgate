 ...
 *
 * For this first implementation the counts are carried in the contract's
 * private state. A later iteration will populate them from real scanners
 * (Gitleaks, Semgrep); nothing here depends on that.
 */
